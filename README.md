...
This is an interactive instrument based on capacitive sensing circuitry, You're enjoying an evening campfire in the woods, use the mug to create some ambience, but beware of things lurking in the forest or the WATER...
